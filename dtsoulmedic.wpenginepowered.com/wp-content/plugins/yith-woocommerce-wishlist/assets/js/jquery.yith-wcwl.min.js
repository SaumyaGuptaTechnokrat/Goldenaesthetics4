jQuery(function(l) {
    ...
    function e() {
        ...
        "undefined" != typeof l.prettyPhoto && (t = {
        ...
        }, l('a[data-rel^="prettyPhoto[add_to_wishlist_"]').add('a[data-rel="prettyPhoto[ask_an_estimate]"]').add('a[data-rel="prettyPhoto[create_wishlist]"]').off("click").prettyPhoto(t), l('a[data-rel="prettyPhoto[move_to_another_wishlist]"]').on("click", function() {
            var t = l(this),
            ...
            for (var e in t) {
                e = t[e];
                "childList" === e.type && ("undefined" != typeof e.addedNodes && "function" == typeof e.addedNodes.forEach && e.addedNodes.forEach(i), "undefined" != typeof e.removedNodes && "function" == typeof e.addedNodes.forEach && e.removedNodes.forEach(a))
            }
    ...
    function w() {
        l(".wishlist_table").filter(".images_grid").not(".enhanced").on("click", "[data-row-id] .product-thumbnail a", function(t) {
            var e, i, a;
            yith_wcwl_l10n.disable_popup_grid_view || (i = (e = l(this).closest("[data-row-id]")).siblings("[data-row-id]"), a = e.find(".item-details"), t.preventDefault(), a.length && (i.removeClass("show"), e.toggleClass("show")))
    ...
    function b(t, e) {
        if ("undefined" != typeof l.prettyPhoto && "undefined" != typeof l.prettyPhoto.close)
            if (void 0 !== t) {
                var i, a = l(".pp_content_container"),
                    n = a.find(".pp_content"),
                    o = a.find(".yith-wcwl-popup-form"),
                    a = o.closest(".pp_pic_holder");
                o.length && ((i = l("<div/>", {
                    ...
                    "class": "feedback",
                    html: t
                })), i.css("display", "none"), n.css("height", "auto"), o.after(i), o.fadeOut(200, function() {
                    i.fadeIn()
                }), a.addClass("feedback"), a.css("left", l(window).innerWidth() / 2 - a.outerWidth() / 2 + "px"), "undefined" != typeof yith_wcwl_l10n.auto_close_popup && !yith_wcwl_l10n.auto_close_popup || setTimeout(b, yith_wcwl_l10n.popup_timeout))
            } else try {
                l.prettyPhoto.close()
            } catch (s) {}
    }
    ...
    l(document).on("yith_wcwl_init", function() {
        ...
        t.on("click", ".add_to_wishlist", function(t) {
            ...
            var i = l(t.target).data("product_id"),
                a = e.variation_id,
                t = l(".yith-wcwl-add-to-wishlist").find('[data-product-id="' + i + '"]'),
                e = l(".yith-wcwl-add-to-wishlist").find('[data-original-product-id="' + i + '"]'),
                t = t.add(e),
