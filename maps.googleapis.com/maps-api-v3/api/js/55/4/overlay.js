google.maps.__gjsload__('overlay', function(_) {
    var vE = function(a) {
        ...
        kla = function(a, b) {
            ...
            a.bindTo("panes", f);
            e = () => _.Km(d.Ea);
            c.Sa = [_.dk(a, "panes_changed", e), _.dk(f, "zoom_changed", e), _.dk(f, "offset_changed", e), _.dk(b, "projection_changed", e), _.dk(f, "projectioncenterq_changed", e)];
            _.Km(d.Ea);
            b instanceof _.Ak ? (_.kl(b, "Ox"), _.il(b, 148440)) : b instanceof _.Fl && (_.kl(b, "Oxs"),
                _.il(b, 181451))
        },
        pla = function(a) {
            if (a) {
                ...
                if (lla(a) !== b && b && b instanceof _.Ak) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new mla(b, a, c.overlayLayer) : c.qb.then(({
                        da: d
                    }) => {
                        const e = new nla(b, d);
                        d.Ib(e);
        ...
        ola = function(a) {
            if (a) {
                var b = a.__gmop;
                b && (a.__gmop = null, b.g.unbindAll(), b.g.set("panes", null), b.g.set("projection", null), b.i.Qe(b), b.h && (b.h = !1, b.g.onRemove ? b.g.onRemove() : b.g.remove()))
            }
        },
        lla = function(a) {
    ...
    vE.prototype.changed = function(a) {
        "outProjection" != a && (a = !!(this.get("offset") && this.get("projectionTopLeft") && this.get("projection") && _.Qi(this.get("zoom"))), a == !this.get("outProjection") && this.set("outProjection", a ? this.g : null))
    };
    var xE = {};
    _.Ca(jla, _.uk);
    xE.re = function(a) {
